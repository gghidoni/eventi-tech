...
class AsyncSelectServiceProvider extends ServiceProvider
{
    ...
    {
        return Http\Middleware\InternalAuthenticate::class;
    }
    ...
    public function boot(): void
    {
        ...
        if ($this->app->runningInConsole()) {
            $this->commands([
                Console\GenerateInternalSecretCommand::class,
            ]);
        }
    ...
    protected function registerMiddleware(): void
    {
        ...
        $middlewareClass = Http\Middleware\InternalAuthenticate::class;
