...
return [
    ...
    'forgot_password' => [
        ...
        'sent'          => 'Ti abbiamo inviato un link per reimpostare la password.',
    ...
    'verify_email' => [
        ...
        'intro'         => 'Per favore verifica il tuo indirizzo email cliccando sul link che ti abbiamo appena inviato.',
        'sent'          => 'Un nuovo link di verifica è stato inviato all’indirizzo email fornito durante la registrazione.',
        'resend_button' => 'Reinvia email di verifica',
        'logout_button' => 'Esci',
    ],
    'thanks' => [
